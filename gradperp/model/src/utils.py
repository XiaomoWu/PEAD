...
def add_derived_cfg_before_init(cfg: DictConfig) -> None:
    ...
    if 'glove' in cfg.datamodule.preemb_dir:
        cfg.model.d_model = 300
    elif ('mpnet' in cfg.datamodule.preemb_dir) | ('finbert' in cfg.datamodule.preemb_dir):
        cfg.model.d_model = 768
        cfg.model.nhead = 12
        cfg.model.d_ffn = 1024
    elif ('llama' in cfg.datamodule.preemb_dir):
        cfg.model.d_model = 768
        cfg.model.nhead = 12
        cfg.model.d_ffn = 1024
